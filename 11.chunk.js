...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__stocks_routing__ = __webpack_require__(1716);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__stocks_component__ = __webpack_require__(1640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_stocks_table_stocks_service__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_stocks_table_stocks_table_component__ = __webpack_require__(1639);
...
StocksModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__stocks_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__stocks_component__["a" /* StocksComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_stocks_table_stocks_table_component__["a" /* StocksTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_stocks_table_stocks_service__["a" /* StocksService */]
        ]
    })
], StocksModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__stocks_service__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__stocks_add_modal_stocks_add_modal_component__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__stocks_edit_modal_stocks_edit_modal_component__ = __webpack_require__(673);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__salidastocks_components_salidastocks_table_salidastocks_add_modal_salidastocks_add_modal_component__ = __webpack_require__(619);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StocksTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StocksTableComponent = (function () {
    function StocksTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    StocksTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    StocksTableComponent.prototype.refill = function () {
        this.getAll();
    };
    StocksTableComponent.prototype.insertSalidastock = function (stocks) {
        var _this = this;
        var salidastock = {
            stock_idstock: stocks.idstock
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_8__salidastocks_components_salidastocks_table_salidastocks_add_modal_salidastocks_add_modal_component__["a" /* SalidastocksAddModalComponent */], salidastock)
    ...
    StocksTableComponent.prototype.salidastockShowToast = function (result) {
        if (result.success) {
    ...
    StocksTableComponent.prototype.viewSalidastock = function (stocks) {
        this.router.navigate(["/pages/salidastocks/stock/" + stocks.idstock]);
    };
    StocksTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__stocks_add_modal_stocks_add_modal_component__["a" /* StocksAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    StocksTableComponent.prototype.editModalShow = function (stocks) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__stocks_edit_modal_stocks_edit_modal_component__["a" /* StocksEditModalComponent */], stocks)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    StocksTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    StocksTableComponent.prototype.showToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    StocksTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
StocksComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'stocks',
        template: __webpack_require__(1900)
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stocks_component__ = __webpack_require__(1640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_stocks_table_stocks_table_component__ = __webpack_require__(1639);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__stocks_component__["a" /* StocksComponent */],
        children: [
            { path: 'stocks-table', component: __WEBPACK_IMPORTED_MODULE_2__components_stocks_table_stocks_table_component__["a" /* StocksTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=stocks.routing.js.map
...
module.exports = "  <stocks-table></stocks-table>\r\n"
