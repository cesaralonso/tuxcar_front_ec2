...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__productos_routing__ = __webpack_require__(1704);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__productos_component__ = __webpack_require__(1608);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_productos_table_productos_service__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_productos_table_productos_table_component__ = __webpack_require__(1607);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__productos_service__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__productos_add_modal_productos_add_modal_component__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__productos_edit_modal_productos_edit_modal_component__ = __webpack_require__(663);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tareas_components_tareas_table_tareas_add_modal_tareas_add_modal_component__ = __webpack_require__(223);
...
var ProductosTableComponent = (function () {
    function ProductosTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    ProductosTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    ProductosTableComponent.prototype.insertTarea = function (productos) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_9__tareas_components_tareas_table_tareas_add_modal_tareas_add_modal_component__["a" /* TareasAddModalComponent */], tarea)
            .subscribe(function (data) {
            if (data) {
    ...
    ProductosTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__productos_add_modal_productos_add_modal_component__["a" /* ProductosAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    ProductosTableComponent.prototype.editModalShow = function (productos) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__productos_edit_modal_productos_edit_modal_component__["a" /* ProductosEditModalComponent */], productos)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__productos_component__ = __webpack_require__(1608);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_productos_table_productos_table_component__ = __webpack_require__(1607);
