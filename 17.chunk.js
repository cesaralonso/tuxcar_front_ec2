...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sexos_routing__ = __webpack_require__(1710);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__sexos_component__ = __webpack_require__(1628);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_sexos_table_sexos_service__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_sexos_table_sexos_table_component__ = __webpack_require__(1627);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SexosModule", function() { return SexosModule; });
...
var SexosModule = (function () {
    function SexosModule() {
    }
    return SexosModule;
}());
SexosModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__sexos_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__sexos_component__["a" /* SexosComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_sexos_table_sexos_table_component__["a" /* SexosTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_sexos_table_sexos_service__["a" /* SexosService */]
        ]
    })
], SexosModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sexos_service__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sexos_add_modal_sexos_add_modal_component__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sexos_edit_modal_sexos_edit_modal_component__ = __webpack_require__(667);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SexosTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SexosTableComponent = (function () {
    function SexosTableComponent(service, toastrService, dialogService, authService, route, router) {
        ...
        if (user.super) {
            ...
            if (userModules[0]) {
                for (var element in userModules) {
                    if (userModules[element].path === '/pages/sexos') {
    ...
    SexosTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    SexosTableComponent.prototype.refill = function () {
        this.getAll();
    };
    SexosTableComponent.prototype.insertPersona = function (sexos) {
        var _this = this;
        var persona = {
    ...
    SexosTableComponent.prototype.personaShowToast = function (result) {
        if (result.success) {
    ...
    SexosTableComponent.prototype.viewPersona = function (sexos) {
        this.router.navigate(["/pages/personas/sexo/" + sexos.idsexo]);
    };
    SexosTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__sexos_add_modal_sexos_add_modal_component__["a" /* SexosAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    SexosTableComponent.prototype.editModalShow = function (sexos) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__sexos_edit_modal_sexos_edit_modal_component__["a" /* SexosEditModalComponent */], sexos)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    SexosTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    SexosTableComponent.prototype.showToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    SexosTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SexosComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SexosComponent = (function () {
    function SexosComponent() {
    }
    SexosComponent.prototype.ngOnInit = function () {
    };
    return SexosComponent;
}());
SexosComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'sexos',
        template: __webpack_require__(1888)
    }),
    __metadata("design:paramtypes", [])
], SexosComponent);

//# sourceMappingURL=sexos.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sexos_component__ = __webpack_require__(1628);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_sexos_table_sexos_table_component__ = __webpack_require__(1627);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__sexos_component__["a" /* SexosComponent */],
        children: [
            { path: 'sexos-table', component: __WEBPACK_IMPORTED_MODULE_2__components_sexos_table_sexos_table_component__["a" /* SexosTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=sexos.routing.js.map
...
module.exports = "  <sexos-table></sexos-table>\r\n"
