...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__choferestados_routing__ = __webpack_require__(1666);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__choferestados_component__ = __webpack_require__(1540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_choferestados_table_choferestados_service__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_choferestados_table_choferestados_table_component__ = __webpack_require__(1541);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChoferestadosModule", function() { return ChoferestadosModule; });
...
var ChoferestadosModule = (function () {
    function ChoferestadosModule() {
    }
    return ChoferestadosModule;
}());
ChoferestadosModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__choferestados_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__choferestados_component__["a" /* ChoferestadosComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_choferestados_table_choferestados_table_component__["a" /* ChoferestadosTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_choferestados_table_choferestados_service__["a" /* ChoferestadosService */]
        ]
    })
], ChoferestadosModule);

//# sourceMappingURL=choferestados.module.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChoferestadosComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChoferestadosComponent = (function () {
    function ChoferestadosComponent() {
    }
    ChoferestadosComponent.prototype.ngOnInit = function () {
    };
    return ChoferestadosComponent;
}());
ChoferestadosComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'choferestados',
        template: __webpack_require__(1805)
    }),
    __metadata("design:paramtypes", [])
], ChoferestadosComponent);

//# sourceMappingURL=choferestados.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__choferestados_service__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__choferestados_add_modal_choferestados_add_modal_component__ = __webpack_require__(610);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__choferestados_edit_modal_choferestados_edit_modal_component__ = __webpack_require__(632);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChoferestadosTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChoferestadosTableComponent = (function () {
    function ChoferestadosTableComponent(service, toastrService, dialogService, authService, route, router) {
        ...
        if (user.super) {
            ...
            if (userModules[0]) {
                for (var element in userModules) {
                    if (userModules[element].path === '/pages/choferestados') {
    ...
    ChoferestadosTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    ChoferestadosTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    ChoferestadosTableComponent.prototype.findByIdChofer = function (id) {
        var _this = this;
        this.service
            .findByIdChofer(id)
    ...
    ChoferestadosTableComponent.prototype.findByIdEstadoactividad = function (id) {
        var _this = this;
        this.service
    ...
    ChoferestadosTableComponent.prototype.backPage = function () {
        window.history.back();
    };
    ChoferestadosTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__choferestados_add_modal_choferestados_add_modal_component__["a" /* ChoferestadosAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    ChoferestadosTableComponent.prototype.editModalShow = function (choferestados) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__choferestados_edit_modal_choferestados_edit_modal_component__["a" /* ChoferestadosEditModalComponent */], choferestados)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    ChoferestadosTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
        if (window.confirm('¿Estas seguro de querer eliminar este registro?')) {
            this.service.remove(item.idchoferestado)
    ...
    ChoferestadosTableComponent.prototype.showToast = function (result) {
        if (result.success) {
    ...
    ChoferestadosTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__choferestados_component__ = __webpack_require__(1540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_choferestados_table_choferestados_table_component__ = __webpack_require__(1541);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__choferestados_component__["a" /* ChoferestadosComponent */],
        children: [
            { path: 'choferestados-table', component: __WEBPACK_IMPORTED_MODULE_2__components_choferestados_table_choferestados_table_component__["a" /* ChoferestadosTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=choferestados.routing.js.map
...
module.exports = "  <choferestados-table></choferestados-table>\r\n"
