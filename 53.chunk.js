...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__bonificacions_routing__ = __webpack_require__(1664);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__bonificacions_component__ = __webpack_require__(1536);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_bonificacions_table_bonificacions_service__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_bonificacions_table_bonificacions_table_component__ = __webpack_require__(1537);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BonificacionsModule", function() { return BonificacionsModule; });
...
var BonificacionsModule = (function () {
    function BonificacionsModule() {
    }
    return BonificacionsModule;
}());
BonificacionsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__bonificacions_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__bonificacions_component__["a" /* BonificacionsComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_bonificacions_table_bonificacions_table_component__["a" /* BonificacionsTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_bonificacions_table_bonificacions_service__["a" /* BonificacionsService */]
        ]
    })
], BonificacionsModule);

//# sourceMappingURL=bonificacions.module.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BonificacionsComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BonificacionsComponent = (function () {
    function BonificacionsComponent() {
    }
    BonificacionsComponent.prototype.ngOnInit = function () {
    };
    return BonificacionsComponent;
}());
BonificacionsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'bonificacions',
        template: __webpack_require__(1802)
    }),
    __metadata("design:paramtypes", [])
], BonificacionsComponent);

//# sourceMappingURL=bonificacions.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__bonificacions_service__ = __webpack_require__(226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bonificacions_add_modal_bonificacions_add_modal_component__ = __webpack_require__(609);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__bonificacions_edit_modal_bonificacions_edit_modal_component__ = __webpack_require__(631);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BonificacionsTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BonificacionsTableComponent = (function () {
    function BonificacionsTableComponent(service, toastrService, dialogService, authService, route, router) {
        ...
        if (user.super) {
            ...
            if (userModules[0]) {
                for (var element in userModules) {
                    if (userModules[element].path === '/pages/bonificacions') {
    ...
    BonificacionsTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    BonificacionsTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    BonificacionsTableComponent.prototype.findByIdChofer = function (id) {
        var _this = this;
        this.service
            .findByIdChofer(id)
    ...
    BonificacionsTableComponent.prototype.findByIdEstado = function (id) {
        var _this = this;
        this.service
            .findByIdEstado(id)
            .subscribe(function (data) {
    ...
    BonificacionsTableComponent.prototype.backPage = function () {
        window.history.back();
    };
    BonificacionsTableComponent.prototype.validateBonification = function (bonificacions) {
        var _this = this;
        var bonificacion = {
            'validado': true,
    ...
    BonificacionsTableComponent.prototype.applyBonification = function (bonificacions) {
        var _this = this;
        this.service.applyBonification(bonificacions)
            .subscribe(function (data) { return _this.showToast(data); }, function (error) { return console.log(error); }, function () { return console.log('Delete completed'); });
    };
    BonificacionsTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__bonificacions_add_modal_bonificacions_add_modal_component__["a" /* BonificacionsAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    BonificacionsTableComponent.prototype.editModalShow = function (bonificacions) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__bonificacions_edit_modal_bonificacions_edit_modal_component__["a" /* BonificacionsEditModalComponent */], bonificacions)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    BonificacionsTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    BonificacionsTableComponent.prototype.showToast = function (result) {
        if (result.success) {
    ...
    BonificacionsTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bonificacions_component__ = __webpack_require__(1536);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_bonificacions_table_bonificacions_table_component__ = __webpack_require__(1537);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__bonificacions_component__["a" /* BonificacionsComponent */],
        children: [
            { path: 'bonificacions-table', component: __WEBPACK_IMPORTED_MODULE_2__components_bonificacions_table_bonificacions_table_component__["a" /* BonificacionsTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=bonificacions.routing.js.map
...
module.exports = "  <bonificacions-table></bonificacions-table>\r\n"
