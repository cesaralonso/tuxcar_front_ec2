...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__areas_routing__ = __webpack_require__(1663);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__areas_component__ = __webpack_require__(1534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_areas_table_areas_service__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_areas_table_areas_table_component__ = __webpack_require__(1535);
...
AreasModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__areas_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__areas_component__["a" /* AreasComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_areas_table_areas_table_component__["a" /* AreasTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_areas_table_areas_service__["a" /* AreasService */]
        ]
    })
], AreasModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__areas_service__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__areas_add_modal_areas_add_modal_component__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__areas_edit_modal_areas_edit_modal_component__ = __webpack_require__(630);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__empleados_components_empleados_table_empleados_add_modal_empleados_add_modal_component__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__productos_components_productos_table_productos_add_modal_productos_add_modal_component__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tareas_components_tareas_table_tareas_add_modal_tareas_add_modal_component__ = __webpack_require__(223);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AreasTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AreasTableComponent = (function () {
    function AreasTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    AreasTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    AreasTableComponent.prototype.refill = function () {
        this.getAll();
    };
    AreasTableComponent.prototype.insertEmpleado = function (areas) {
        var _this = this;
        var empleado = {
    ...
    AreasTableComponent.prototype.empleadoShowToast = function (result) {
        if (result.success) {
    ...
    AreasTableComponent.prototype.viewEmpleado = function (areas) {
        this.router.navigate(["/pages/empleados/area/" + areas.idarea]);
    };
    AreasTableComponent.prototype.insertProducto = function (areas) {
        var _this = this;
        var producto = {
            area_idarea: areas.idarea
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_9__productos_components_productos_table_productos_add_modal_productos_add_modal_component__["a" /* ProductosAddModalComponent */], producto)
            .subscribe(function (data) {
            if (data) {
                _this.productoShowToast(data);
            }
        });
    };
    AreasTableComponent.prototype.productoShowToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    AreasTableComponent.prototype.viewProducto = function (areas) {
        this.router.navigate(["/pages/productos/area/" + areas.idarea]);
    };
    AreasTableComponent.prototype.insertTarea = function (areas) {
        var _this = this;
        var tarea = {
            area_idarea: areas.idarea
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_10__tareas_components_tareas_table_tareas_add_modal_tareas_add_modal_component__["a" /* TareasAddModalComponent */], tarea)
            .subscribe(function (data) {
            if (data) {
    ...
    AreasTableComponent.prototype.tareaShowToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    AreasTableComponent.prototype.viewTarea = function (areas) {
        this.router.navigate(["/pages/tareas/area/" + areas.idarea]);
    };
    AreasTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__areas_add_modal_areas_add_modal_component__["a" /* AreasAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    AreasTableComponent.prototype.editModalShow = function (areas) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__areas_edit_modal_areas_edit_modal_component__["a" /* AreasEditModalComponent */], areas)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    AreasTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    AreasTableComponent.prototype.showToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    AreasTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__areas_component__ = __webpack_require__(1534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_areas_table_areas_table_component__ = __webpack_require__(1535);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__areas_component__["a" /* AreasComponent */],
        children: [
            { path: 'areas-table', component: __WEBPACK_IMPORTED_MODULE_2__components_areas_table_areas_table_component__["a" /* AreasTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=areas.routing.js.map
...
module.exports = "  <areas-table></areas-table>\r\n"
