...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__clientes_routing__ = __webpack_require__(1669);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__clientes_component__ = __webpack_require__(1546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_clientes_table_clientes_service__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_clientes_table_clientes_table_component__ = __webpack_require__(1547);
...
ClientesModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__clientes_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__clientes_component__["a" /* ClientesComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_clientes_table_clientes_table_component__["a" /* ClientesTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_clientes_table_clientes_service__["a" /* ClientesService */]
        ]
    })
], ClientesModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__clientes_service__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__clientes_add_modal_clientes_add_modal_component__ = __webpack_require__(227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__clientes_edit_modal_clientes_edit_modal_component__ = __webpack_require__(635);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ordens_components_ordens_table_ordens_add_modal_ordens_add_modal_component__ = __webpack_require__(52);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClientesTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ClientesTableComponent = (function () {
    function ClientesTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    ClientesTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    ClientesTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    ClientesTableComponent.prototype.findByIdPersona = function (id) {
        var _this = this;
        this.service
            .findByIdPersona(id)
    ...
    ClientesTableComponent.prototype.backPage = function () {
        window.history.back();
    };
    ClientesTableComponent.prototype.insertOrden = function (clientes) {
        var _this = this;
        var orden = {
            cliente_idcliente: clientes.idcliente
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_8__ordens_components_ordens_table_ordens_add_modal_ordens_add_modal_component__["a" /* OrdensAddModalComponent */], orden)
            .subscribe(function (data) {
            if (data) {
    ...
    ClientesTableComponent.prototype.ordenShowToast = function (result) {
        if (result.success) {
    ...
    ClientesTableComponent.prototype.viewOrden = function (clientes) {
        this.router.navigate(["/pages/ordens/cliente/" + clientes.idcliente]);
    };
    ClientesTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__clientes_add_modal_clientes_add_modal_component__["a" /* ClientesAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    ClientesTableComponent.prototype.editModalShow = function (clientes) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__clientes_edit_modal_clientes_edit_modal_component__["a" /* ClientesEditModalComponent */], clientes)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    ClientesTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    ClientesTableComponent.prototype.showToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    ClientesTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__clientes_component__ = __webpack_require__(1546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_clientes_table_clientes_table_component__ = __webpack_require__(1547);
...
var routes = [
    {
        ...
        children: [
            { path: 'clientes-table', component: __WEBPACK_IMPORTED_MODULE_2__components_clientes_table_clientes_table_component__["a" /* ClientesTableComponent */] }
        ]
    }
];
...
module.exports = "  <clientes-table></clientes-table>\r\n"
