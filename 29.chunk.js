...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ordentareas_routing__ = __webpack_require__(1696);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ordentareas_component__ = __webpack_require__(1592);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_ordentareas_table_ordentareas_service__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_ordentareas_table_ordentareas_table_component__ = __webpack_require__(1591);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ordentareas_service__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ordentareas_add_modal_ordentareas_add_modal_component__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ordentareas_edit_modal_ordentareas_edit_modal_component__ = __webpack_require__(655);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__empleadotareas_components_empleadotareas_table_empleadotareas_add_modal_empleadotareas_add_modal_component__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__salidastocks_components_salidastocks_table_salidastocks_add_modal_salidastocks_add_modal_component__ = __webpack_require__(619);
...
var OrdentareasTableComponent = (function () {
    function OrdentareasTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    OrdentareasTableComponent.prototype.cancelarOrdenTarea = function (ordentareas) {
        var _this = this;
    ...
    OrdentareasTableComponent.prototype.insertEmpleadotarea = function (ordentareas) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_8__empleadotareas_components_empleadotareas_table_empleadotareas_add_modal_empleadotareas_add_modal_component__["a" /* EmpleadotareasAddModalComponent */], empleadotarea)
            .subscribe(function (data) {
            if (data) {
    ...
    OrdentareasTableComponent.prototype.insertSalidastock = function (ordentareas) {
        var _this = this;
        var salidastock = {
            ordentarea_idordentarea: ordentareas.idordentarea
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_10__salidastocks_components_salidastocks_table_salidastocks_add_modal_salidastocks_add_modal_component__["a" /* SalidastocksAddModalComponent */], salidastock)
            .subscribe(function (data) {
            if (data) {
                _this.salidastockShowToast(data);
            }
        });
    };
    OrdentareasTableComponent.prototype.salidastockShowToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    OrdentareasTableComponent.prototype.viewSalidastock = function (ordentareas) {
        this.router.navigate(["/pages/salidastocks/ordentarea/" + ordentareas.idordentarea]);
    };
    OrdentareasTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__ordentareas_add_modal_ordentareas_add_modal_component__["a" /* OrdentareasAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    OrdentareasTableComponent.prototype.editModalShow = function (ordentareas) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__ordentareas_edit_modal_ordentareas_edit_modal_component__["a" /* OrdentareasEditModalComponent */], ordentareas)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ordentareas_component__ = __webpack_require__(1592);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ordentareas_table_ordentareas_table_component__ = __webpack_require__(1591);
