...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__velizs_routing__ = __webpack_require__(1726);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__velizs_component__ = __webpack_require__(1660);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_velizs_table_velizs_service__ = __webpack_require__(318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_velizs_table_velizs_table_component__ = __webpack_require__(1659);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VelizsModule", function() { return VelizsModule; });
...
var VelizsModule = (function () {
    function VelizsModule() {
    }
    return VelizsModule;
}());
VelizsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__velizs_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__velizs_component__["a" /* VelizsComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_velizs_table_velizs_table_component__["a" /* VelizsTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_velizs_table_velizs_service__["a" /* VelizsService */]
        ]
    })
], VelizsModule);

//# sourceMappingURL=velizs.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__velizs_service__ = __webpack_require__(318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__velizs_add_modal_velizs_add_modal_component__ = __webpack_require__(682);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__velizs_edit_modal_velizs_edit_modal_component__ = __webpack_require__(683);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VelizsTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VelizsTableComponent = (function () {
    function VelizsTableComponent(service, toastrService, dialogService, authService, route, router) {
        ...
        if (user.super) {
            ...
            if (userModules[0]) {
                for (var element in userModules) {
                    if (userModules[element].path === '/pages/velizs') {
    ...
    VelizsTableComponent.prototype.ngOnInit = function () {
        this.refill();
    };
    VelizsTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    VelizsTableComponent.prototype.findByIdChofer = function (id) {
        var _this = this;
        this.service
            .findByIdChofer(id)
    ...
    VelizsTableComponent.prototype.findByIdEstado = function (id) {
        var _this = this;
        this.service
            .findByIdEstado(id)
            .subscribe(function (data) {
    ...
    VelizsTableComponent.prototype.backPage = function () {
        window.history.back();
    };
    VelizsTableComponent.prototype.filtrarFechas = function (fechaDesde, fechaHasta) {
        var _this = this;
        this.service
    ...
    VelizsTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__velizs_add_modal_velizs_add_modal_component__["a" /* VelizsAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    VelizsTableComponent.prototype.editModalShow = function (velizs) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__velizs_edit_modal_velizs_edit_modal_component__["a" /* VelizsEditModalComponent */], velizs)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    VelizsTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    VelizsTableComponent.prototype.showToast = function (result) {
        if (result.success) {
    ...
    VelizsTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (data) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VelizsComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VelizsComponent = (function () {
    function VelizsComponent() {
    }
    VelizsComponent.prototype.ngOnInit = function () {
    };
    return VelizsComponent;
}());
VelizsComponent = __decorate([
...
//# sourceMappingURL=velizs.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__velizs_component__ = __webpack_require__(1660);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_velizs_table_velizs_table_component__ = __webpack_require__(1659);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__velizs_component__["a" /* VelizsComponent */],
        children: [
            { path: 'velizs-table', component: __WEBPACK_IMPORTED_MODULE_2__components_velizs_table_velizs_table_component__["a" /* VelizsTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=velizs.routing.js.map
...
module.exports = "  <velizs-table></velizs-table>\r\n"
