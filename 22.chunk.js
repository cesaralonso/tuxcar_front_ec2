...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__personas_routing__ = __webpack_require__(1703);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__personas_component__ = __webpack_require__(1606);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_personas_table_personas_service__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_personas_table_personas_table_component__ = __webpack_require__(1605);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__personas_service__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__personas_add_modal_personas_add_modal_component__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__personas_edit_modal_personas_edit_modal_component__ = __webpack_require__(662);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__chofers_components_chofers_table_chofers_add_modal_chofers_add_modal_component__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__clientes_components_clientes_table_clientes_add_modal_clientes_add_modal_component__ = __webpack_require__(227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__empleados_components_empleados_table_empleados_add_modal_empleados_add_modal_component__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__permisotaxis_components_permisotaxis_table_permisotaxis_add_modal_permisotaxis_add_modal_component__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__vehiculos_components_vehiculos_table_vehiculos_add_modal_vehiculos_add_modal_component__ = __webpack_require__(84);
...
var PersonasTableComponent = (function () {
    function PersonasTableComponent(service, toastrService, dialogService, authService, route, router) {
    ...
    PersonasTableComponent.prototype.refill = function () {
        var _this = this;
    ...
    PersonasTableComponent.prototype.findByIdChofer = function (id) {
        var _this = this;
        this.service
            .findByIdChofer(id)
            .subscribe(function (data) {
    ...
    PersonasTableComponent.prototype.insertChofer = function (personas) {
        var _this = this;
        var chofer = {
            chofer: personas.idpersona,
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_8__chofers_components_chofers_table_chofers_add_modal_chofers_add_modal_component__["a" /* ChofersAddModalComponent */], chofer)
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.choferShowToast = function (result) {
        if (result.success) {
    ...
    PersonasTableComponent.prototype.viewChofer = function (personas) {
    ...
    PersonasTableComponent.prototype.insertCliente = function (personas) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_9__clientes_components_clientes_table_clientes_add_modal_clientes_add_modal_component__["a" /* ClientesAddModalComponent */], cliente)
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.insertEmpleado = function (personas) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_10__empleados_components_empleados_table_empleados_add_modal_empleados_add_modal_component__["a" /* EmpleadosAddModalComponent */], empleado)
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.insertPermisotaxi = function (personas) {
        var _this = this;
        var permisotaxi = {
            propietario: personas.idpersona,
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_11__permisotaxis_components_permisotaxis_table_permisotaxis_add_modal_permisotaxis_add_modal_component__["a" /* PermisotaxisAddModalComponent */], permisotaxi)
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.permisotaxiShowToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    PersonasTableComponent.prototype.viewPermisotaxi = function (personas) {
        this.router.navigate(["/pages/permisotaxis/persona/" + personas.idpersona]);
    };
    PersonasTableComponent.prototype.insertVehiculo = function (personas) {
        var _this = this;
        var vehiculo = {
            propietario: personas.idpersona
        };
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_12__vehiculos_components_vehiculos_table_vehiculos_add_modal_vehiculos_add_modal_component__["a" /* VehiculosAddModalComponent */], vehiculo)
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.vehiculoShowToast = function (result) {
        if (result.success) {
            this.toastrService.success(result.message);
            this.refill();
        }
    ...
    PersonasTableComponent.prototype.viewVehiculo = function (personas) {
        this.router.navigate(["/pages/vehiculos/persona/" + personas.idpersona]);
    };
    PersonasTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__personas_add_modal_personas_add_modal_component__["a" /* PersonasAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    PersonasTableComponent.prototype.editModalShow = function (personas) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__personas_edit_modal_personas_edit_modal_component__["a" /* PersonasEditModalComponent */], personas)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__personas_component__ = __webpack_require__(1606);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_personas_table_personas_table_component__ = __webpack_require__(1605);
